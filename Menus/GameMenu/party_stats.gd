...
func update_character1_block(party_member1 : Combatant):
...
func update_character2_block(party_member2 : Combatant):
...
func update_character3_block(party_member3 : Combatant):
...
func update_character4_block(party_member1 : Combatant):
