...
var default_stats = [10,10,10,10,10,10,10]
...
func set_player1_inventory_data(member : Combatant):
	...
	set_member1_labels(member)
	set_member1_stats(member.get_stats())

func set_player2_inventory_data(member : Combatant):
	...
	set_member2_labels(member)
	set_member2_stats(member.get_stats())

func set_player3_inventory_data(member : Combatant):
	...
	set_member3_labels(member)
	set_member3_stats(member.get_stats())

func set_player4_inventory_data(member : Combatant):
	...
	set_member4_labels(member)
	set_member4_stats(member.get_stats())
...
func set_member1_labels(member : Combatant):
	%Character1NameE.text = member.get_combatant_name()
	%Character1NameS.text = member.get_combatant_name()
	
	%Character1ClassE.text = member.rpg_class.get_rpg_class()
	%Character1ClassS.text = member.rpg_class.get_rpg_class()

func set_member2_labels(member : Combatant):
	%Character2NameE.text = member.get_combatant_name()
	%Character2NameS.text = member.get_combatant_name()
	
	%Character2ClassE.text = member.rpg_class.get_rpg_class()
	%Character2ClassS.text = member.rpg_class.get_rpg_class()

func set_member3_labels(member : Combatant):
	%Character3NameE.text = member.get_combatant_name()
	%Character3NameS.text = member.get_combatant_name()
	
	%Character3ClassE.text = member.rpg_class.get_rpg_class()
	%Character3ClassS.text = member.rpg_class.get_rpg_class()

func set_member4_labels(member : Combatant):
	%Character4NameE.text = member.get_combatant_name()
	%Character4NameS.text = member.get_combatant_name()
	
	%Character4ClassE.text = member.rpg_class.get_rpg_class()
	%Character4ClassS.text = member.rpg_class.get_rpg_class()

func set_member1_stats(stat_array : Array):
	%Character1Strength.text = str(stat_array[0])
	%Character1Agility.text = str(stat_array[1])
	%Character1Endurance.text = str(stat_array[2])
	%Character1Inteligence.text = str(stat_array[3])
	%Character1Devotion.text = str(stat_array[4])
	%Character1Cooking.text = str(stat_array[5])
	%Character1Luck.text = str(stat_array[6])

func set_member2_stats(stat_array : Array):
	%Character2Strength.text = str(stat_array[0])
	%Character2Agility.text = str(stat_array[1])
	%Character2Endurance.text = str(stat_array[2])
	%Character2Inteligence.text = str(stat_array[3])
	%Character2Devotion.text = str(stat_array[4])
	%Character2Cooking.text = str(stat_array[5])
	%Character2Luck.text = str(stat_array[6])

func set_member3_stats(stat_array : Array):
	%Character3Strength.text = str(stat_array[0])
	%Character3Agility.text = str(stat_array[1])
	%Character3Endurance.text = str(stat_array[2])
	%Character3Inteligence.text = str(stat_array[3])
	%Character3Devotion.text = str(stat_array[4])
	%Character3Cooking.text = str(stat_array[5])
	%Character3Luck.text = str(stat_array[6])

func set_member4_stats(stat_array : Array):
	%Character4Strength.text = str(stat_array[0])
	%Character4Agility.text = str(stat_array[1])
	%Character4Endurance.text = str(stat_array[2])
	%Character4Inteligence.text = str(stat_array[3])
	%Character4Devotion.text = str(stat_array[4])
	%Character4Cooking.text = str(stat_array[5])
	%Character4Luck.text = str(stat_array[6])

func _on_inv_and_equ_pressed() -> void:
	hide_stats()
